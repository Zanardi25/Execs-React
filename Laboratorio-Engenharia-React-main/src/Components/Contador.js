	...
	return (
		<div className='container'>
			...
			<div class='buttons-container'>
				...
				<h2>Homens: {homens}</h2>
				<button class="button" onClick={() => AddPerson('homens')}>+</button>
				<button onClick={() => RemovePerson('homens')}>-</button>
			</div>
			<div class='buttons-container'>
				<img class="img" src={ImagemMulher} alt={'Mulher'} />
				<h2>Mulheres: {mulheres}</h2>
				<button class="button" onClick={() => AddPerson('mulheres')}>+</button>
				<button onClick={() => RemovePerson('mulheres')}>-</button>
			</div>
